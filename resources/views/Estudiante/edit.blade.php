    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Editar Perfil Estudiante</div>
                <div class="panel-body">

                <p>Datos del Estudiante</p>

                    <form class="form-horizontal" role="form" method="POST" action="/estudiantes/{{$estud->id}}/estud">
                                           {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{$estud->name }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('cedula') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text" class="form-control" name="cedula" value="{{ $estud->cedula }}" required>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ $estud->email }}" required>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label">Confirmar Contraseña 
                            </label>
